...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-08-2023 a las 07:17:22
...
(1, 'carlos', 'mejia', 'POO', '18', 'Aprobado');
...
CREATE TABLE `horario` (
  ...
  `ho_dia` varchar(33) NOT NULL,
  `ho_hora` varchar(33) NOT NULL,
  `ho_materia` varchar(33) NOT NULL,
  `ho_estado` varchar(33) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Lunes', '7:00', 'CALCULO', 'Entrada'),
(2, 'Miercoles', '11:00', 'CALCULO', 'Entrada');
...
(1, 'kelvin', 'peter', 666767, 'kelvin1', 'Contador', 'Activo'),
(3, 'kvhaklhk', 'jkwcdj', 455, 'fiviahn', 'Contador', 'Activo');
...
--
ALTER TABLE `estudiante`
  MODIFY `estu_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
